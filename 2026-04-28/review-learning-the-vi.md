...
Postscript: I discovered today the UTP Revival, which is a
[CC-BY reconstruction
in troff source and PDF output of
O’Reilly’s single-volume Unix Text Processing book](https://github.com/DeriJames/UTP-1.1/tree/master).
The _vi_ and _ex_ chapters of that book are, according to its preface,
based on Linda Lamb’s _Learning the vi editor_.
